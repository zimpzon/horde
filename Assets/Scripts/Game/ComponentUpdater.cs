...
namespace HordeEngine
{
    ...
    /// Order of execution:
    ///  1) CollisionSetup, Early, Default
    ///  2) Unity Update()
    ///  3) Late, RenderSprites, RenderLights
    ///  4) Unity LateUpdate()
    /// </summary>
    public enum ComponentUpdatePass {
        CollisionSetup, Early, Default, // Just before Unity Update()
        Late, RenderSprites, RenderLights // Just before Unity LateUpdate()
    }; 
